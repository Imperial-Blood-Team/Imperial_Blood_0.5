...
function Definitions()
	...
	{
		"StructureForce",
		"Rebel_Ground_Mining_Facility | Empire_Ground_Mining_Facility | Tibanna_Refinery | Tax_Buildings | Support_Buildings | Imperial_Capital | Imperial_Capital | KDY_HQ | MCS_HQ = 1"
	}
	}
